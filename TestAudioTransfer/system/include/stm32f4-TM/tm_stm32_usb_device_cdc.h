 ...
 * @brief    USB CDC Device library for STM32Fxxx devices - http://stm32f4-discovery.com/2015/08/hal-library-21-multi-purpose-usb-library-for-stm32fxxx/
 * @{
 *
...
#define USBD_CDC_BUFFER_SIZE               1024
#endif
